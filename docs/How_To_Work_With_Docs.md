...
doc. The set follows Kernel's **SOP-13 — Progressive-disclosure documentation**; this file is the local,
...
- Full SOP: `~/code/me/org/sop/13-progressive-disclosure-docs.md` (inherited from the Kernel apex)
